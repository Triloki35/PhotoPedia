...
const randomImage = 'https://source.unsplash.com/random/1600x900/?nature,photgraphy,technology'
...
const UserProfile = () => {
  ...
  if (!user) return <div className='flex justify-center items-center h-full'><Spineer message="Loading profile..." /></div>
